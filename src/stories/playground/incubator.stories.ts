...
export const ComponentCodeWrapper = () => `
...
export const SimplerComponentCodeWrapper = () => `
...
export const ComponentWithCodeAndButtons = () => `
    <div class="p-2 sm:p-4">
        <div class="mx-auto max-w-screen-2xl">
            <div class="mb-4">
                <h2 class="mb-2 text-2xl tracking-tight text-neutral-900">Component name</h2>
...
export const ComponentWithCodeAndButtons2 = () => `
    <div class="p-2 sm:p-4">
        <div class="mx-auto max-w-screen-2xl">
            <div class="mb-4">
                <h2 class="mb-2 text-2xl tracking-tight text-neutral-900">Component name</h2>
...
export const ComponentCodeWrapperWithButtons = () => `
    <div class="p-2 sm:p-4 bg-slate-100 h-screen">
...
export const ComponentCodeWrapperWithButtons2 = () => `
    <div class="p-2 sm:p-4 bg-slate-100 h-screen">
        <div class="border border-neutral-300 rounded-xl bg-neutral-100 overflow-hidden mx-auto max-w-screen-xl">
            <div class="px-2 sm:px-4 pt-3 pb-1 border-b border-neutral-300 bg-white">
                <h2 class="mb-2 text-2xl tracking-tight text-neutral-900">Component name</h2>
...
export const ComponentCodeWrapperWithButtons2Collapsed = () => `
    <div class="p-2 sm:p-4 bg-slate-100 h-screen">
        <div class="border border-neutral-300 rounded-xl bg-neutral-100 overflow-hidden mx-auto max-w-screen-xl">
            <div class="px-2 sm:px-4 pt-3 pb-1 border-b border-neutral-300 bg-white">
                <h2 class="mb-2 text-2xl tracking-tight text-neutral-900">Component name</h2>
