const m={title:"Layouts/Brand Guide",parameters:{layout:"fullscreen"}},e=()=>`
...
\``,...(l=(i=e.parameters)==null?void 0:i.docs)==null?void 0:l.source}}};var a,o,r;s.parameters={...s.parameters,docs:{...(a=s.parameters)==null?void 0:a.docs,source:{originalSource:`() => \`
<div id="app" class="antialiased">
        <header class="sm:ml-72 fixed z-30 top-0 w-full flex h-14 p-2 shadow-md bg-white lg:hidden">
            <button class="block p-2 text-zinc-400 hover:text-zinc-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 rounded">
                <svg class="h-6 w-6 fill-current" viewBox="0 0 24 24">
...
\``,...(r=(o=s.parameters)==null?void 0:o.docs)==null?void 0:r.source}}};var c,u,d;t.parameters={...t.parameters,docs:{...(c=t.parameters)==null?void 0:c.docs,source:{originalSource:`() => \`
    <div id="app" class="antialiased">
        <header class="sm:ml-72 fixed z-30 top-0 w-full flex h-14 p-2 shadow-md bg-white lg:hidden">
            <button class="block p-2 text-zinc-400 hover:text-zinc-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 rounded">
                <svg class="h-6 w-6 fill-current" viewBox="0 0 24 24">
...
\``,...(d=(u=t.parameters)==null?void 0:u.docs)==null?void 0:d.source}}};const h=["Empty","Intro","Components"];export{t as Components,e as Empty,s as Intro,h as __namedExportsOrder,m as default};
