const v={title:"Applications/Papers",parameters:{layout:"fullscreen"}},e=()=>`
...
\``,...(o=(n=e.parameters)==null?void 0:n.docs)==null?void 0:o.source}}};var a,i,l;t.parameters={...t.parameters,docs:{...(a=t.parameters)==null?void 0:a.docs,source:{originalSource:`() => \`
    <div class="font-sans antialiased text-gray-950">
        <button class="block sm:hidden fixed inset-0 z-20 bg-black/50"><!-- Side menu backdrop --></button>
...
\``,...(l=(i=t.parameters)==null?void 0:i.docs)==null?void 0:l.source}}};var d,c,g;s.parameters={...s.parameters,docs:{...(d=s.parameters)==null?void 0:d.docs,source:{originalSource:`() => \`
    <div class="font-sans antialiased text-gray-950">
        <aside>
            <nav class="fixed bottom-0 top-0 w-full max-w-80 z-30 sm:hidden lg:block bg-white border-r border-gray-200 overflow-auto">
                <div class="px-4 py-3 sticky top-0 h-14 bg-white z-30 border-b border-gray-200 flex items-center justify-between">
...
\``,...(g=(c=s.parameters)==null?void 0:c.docs)==null?void 0:g.source}}};const p=["Empty","Index","Layout"];export{e as Empty,t as Index,s as Layout,p as __namedExportsOrder,v as default};
