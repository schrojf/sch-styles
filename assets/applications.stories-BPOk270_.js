const o=`<div class="min-h-screen bg-slate-100 text-slate-500 antialiased">
    <div id="app">
        <header class="">
            <button
                id="openSidebarBtn"
...
`,i={title:"Layouts/Applications",parameters:{layout:"fullscreen"}},e=()=>{const n=document.createElement("div");n.innerHTML=o;const t=n.querySelector("#appSidebar"),r=n.querySelector("#appBackDrop"),a=n.querySelector("#closeSidebarBtn");n.querySelector("#openSidebarBtn")?.addEventListener("click",function(){t&&(t.classList.remove("hidden"),r?.classList.remove("hidden"))});function s(){t?.classList.add("hidden"),r?.classList.add("hidden")}return r?.addEventListener("click",s),a?.addEventListener("click",s),n.firstElementChild};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`() => {
