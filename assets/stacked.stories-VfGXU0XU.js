const m={title:"Layouts/Stacked",parameters:{layout:"fullscreen"}},l=()=>{function c(){return`
    ...
    `;function g(e){const o=JSON.parse(e.dataset.toggleClass);e.classList.remove(o.closed),e.classList.add(o.opened)}function p(e){const o=JSON.parse(e.dataset.toggleClass);e.classList.remove(o.opened),e.classList.add(o.closed)}const t={};function r(e){const o=e.dataset.toggleGroup;o&&o in t&&(t[o].isOpen?g(e):p(e))}s.querySelectorAll("[data-toggle-class]").forEach(e=>{const o=e.dataset.toggleGroup;o&&(o in t||(t[o]={isOpen:!1,items:[]}),r(e),t[o].items.push(e))});function a(e){e in t&&t[e].items.forEach(o=>r(o))}s.querySelector("#toggleMenuBtn").addEventListener("click",()=>{"menu"in t&&(t.menu.isOpen=!t.menu.isOpen,a("menu"))}),s.querySelector("#toggleDropdownBtn").addEventListener("click",()=>{"dropdown"in t&&(t.dropdown.isOpen=!t.dropdown.isOpen,a("dropdown"))}),s.querySelector("#closeDropdownOverlay").addEventListener("click",()=>{"dropdown"in t&&(t.dropdown.isOpen=!1,a("dropdown"))});function u(e){"dropdown"in t&&t.dropdown.isOpen&&(e.key=="Esc"||e.key=="Escape")&&(t.dropdown.isOpen=!1,a("dropdown"))}return s.addEventListener("keydown",u),s};var n,d,i;l.parameters={...l.parameters,docs:{...(n=l.parameters)==null?void 0:n.docs,source:{originalSource:`() => {
  ...
  return div;
}`,...(i=(d=l.parameters)==null?void 0:d.docs)==null?void 0:i.source}}};const h=["ResponsiveNavbarLayout"];export{l as ResponsiveNavbarLayout,h as __namedExportsOrder,m as default};
