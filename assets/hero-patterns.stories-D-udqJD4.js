const m={title:"Playground/Hero Patterns",parameters:{layout:"fullscreen"}},r={render:e=>`
    ...
    `,argTypes:{BackgroundColor:{control:"color"},PatternOpacity:{control:{type:"range",min:0,max:1,step:.05}},Width:{control:"text"},Height:{control:"text"}},args:{BackgroundColor:"#dbeafe",PatternOpacity:.15,Width:"100%",Height:"400px"}},a={render:e=>{const s={"Light Minimal":{bg:"#ffffff",opacity:.05,text:"#000000"},"Blue Sky":{bg:"#dbeafe",opacity:.15,text:"#1e40af"},Emerald:{bg:"#d1fae5",opacity:.15,text:"#065f46"},"Warm Sunset":{bg:"#fef3c7",opacity:.2,text:"#92400e"},"Dark Mode":{bg:"#18181b",opacity:.08,text:"#ffffff"},Rose:{bg:"#ffe4e6",opacity:.12,text:"#9f1239"}},t=s[e.Preset]??s["Light Minimal"];return`
        ...
        `},argTypes:{Preset:{control:"select",options:["Light Minimal","Blue Sky","Emerald","Warm Sunset","Dark Mode","Rose"]}},args:{Preset:"Blue Sky"}};var l,i,d;r.parameters={...r.parameters,docs:{...(l=r.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: args => \`
        <div class="h-screen bg-neutral-100 p-8">
            <div
                class="relative overflow-auto resize border border-neutral-300 rounded-lg shadow-md"
...
}`,...(d=(i=r.parameters)==null?void 0:i.docs)==null?void 0:d.source}}};var c,n,g;o.parameters={...o.parameters,docs:{...(c=o.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: args => \`
        <div class="h-screen bg-neutral-100 p-8">
            <div
                class="relative overflow-auto resize border border-neutral-300 rounded-lg shadow-md"
...
}`,...(g=(n=o.parameters)==null?void 0:n.docs)==null?void 0:g.source}}};var u,p,b;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: args => {
...
}`,...(b=(p=a.parameters)==null?void 0:p.docs)==null?void 0:b.source}}};const f=["Glamorous","GlamorousWithContent","GlamorousPresets"];export{r as Glamorous,a as GlamorousPresets,o as GlamorousWithContent,f as __namedExportsOrder,m as default};
